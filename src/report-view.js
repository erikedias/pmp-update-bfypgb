...
(function (root) {
  ...
  const LOGO = {
    ...
    // Google Ads oficial: "A" (barra amarela esq. + barra azul longa dir., unidas no ápice) + círculo VERDE na base esq.
    google: `<svg viewBox="0 0 512 512"><rect x="112.5" y="23" width="105" height="349" rx="52.5" fill="#FBBC04" transform="rotate(29 165 197.5)"/><rect x="271.5" y="31.5" width="112" height="452" rx="56" fill="#4285F4" transform="rotate(-20 327.5 257.5)"/><circle cx="88" cy="400" r="80" fill="#34A853"/></svg>`,
