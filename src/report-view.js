...
(function (root) {
  ...
  const LOGO = {
    ...
    // Google Ads oficial: "A" formado por barra amarela (esq.) + barra azul longa (dir.) + círculo VERDE (base esq.)
    google: `<svg viewBox="0 0 24 24"><line x1="11.2" y1="2.5" x2="3.4" y2="15.9" stroke="#FBBC04" stroke-width="4.7" stroke-linecap="round"/><line x1="12.5" y1="2.5" x2="20.6" y2="20.5" stroke="#4285F4" stroke-width="4.9" stroke-linecap="round"/><circle fill="#34A853" cx="4.6" cy="18.7" r="3"/></svg>`,
